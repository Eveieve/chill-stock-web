...
CREATE TABLE inbound_table (
                               ...
                               inbound_status       VARCHAR(20) NOT NULL,
...
CREATE TABLE outbound_table (
                                ...
                                outbound_status       VARCHAR(20) DEFAULT '대기',
                                admin_id              INT,
...
CREATE TABLE storage_condition (
                                   ...
                                   storage_name ENUM('Ultra-Low_Temp', 'Frozen_Storage', 'Refrigerated_Storage', 'Cool_Storage', 'Room_Temperature', 'Heated_Storage') NOT NULL,
